...
image: /images/blog/2023/dd.jpeg
authors:
  - santiego
---

### B2B marketers have always fought an uphill battle against a common perception: being boring.
...
```tsx emoji="⚠️" type="danger" title="kurwy"
import fs from "fs";
